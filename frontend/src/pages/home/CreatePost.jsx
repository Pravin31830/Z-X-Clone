...
const CreatePost = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    if (!text.trim() && !img ) {
      toast.error("Post must have text or image or video");
      return;
    }
      ...
      <form className='flex flex-col gap-2 w-full' onSubmit={handleSubmit}>
		...
		{video && (
          <div className='relative w-72 mx-auto'>
            ...
            />
            <video src={video} className='w-full mx-auto h-72 object-contain rounded' alt="Post" />
          </div>
        )}
        <div className='flex justify-between border-t py-2 border-t-gray-700'>
		  ...
		  <input accept="video/*" type="file" hidden ref={videoref} onChange={handlevideoChange}/>
